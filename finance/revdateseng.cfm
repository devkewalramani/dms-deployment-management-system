...
<td width="616" height="447" colspan="2" align="left" valign="top" class="style23"><img src="../pics/dms_header.jpg" width="616" height="111"><br>
	...
	<!--- select dates to generate weekly revenue by eng report --->
	<span class="pageheader">Enter date range for the weekly revenue report </span><br>
<form name="form" action="./weekreveng.cfm" method="post" target="_blank">
