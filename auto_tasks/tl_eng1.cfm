...
<cfmail from = "DellManagement@SBSPlanet.com" To = "dkewalramani@sbsplanet.com"  Subject = "Outstanding TaskList Reminder for #SE_FName# #SE_LName#">
<cfmailpart type="html">

<font color="red">TL OSR for #SE_FName# #SE_LName# - #Dateformat(todaysdate,'mm/dd/yy')#</font>
