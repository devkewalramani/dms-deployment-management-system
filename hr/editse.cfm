...
<!--- Select Engineer to edit profile --->

<!--- query all engineers active and inactive --->
...
<span class="pageheader">Select Engineer</span><br>

<form name="Form" action="editse2.cfm" method="post"> 
<select name="EmpID">
