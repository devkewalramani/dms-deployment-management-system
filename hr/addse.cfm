...
<!---
This page/form allows to enter a new engineer
--->
<form action="./add_se_script.cfm" method="post" name="form">
<table width="622">
  <tr>
    <td width="210" bgcolor="#CCCCCC" class="pageheader"><div align="center">First Name </div></td>
    <td width="210" bgcolor="#CCCCCC" class="pageheader"><div align="center">Last Name </div></td>
    <td width="180" bgcolor="#CCCCCC" class="pageheader"><div align="center">Engineer Type</div></td>
    </tr>
  <tr>
    <td>
      <div align="center">
        <input name="fname" type="text" id="fname" size="35" maxlength="50">    
      </div></td>
    <td>
      <div align="center">
        <input name="lname" type="text" id="lname" size="35" maxlength="50">    
      </div></td>
    <td><select name="type">
  ...
  <tr>
    <td><div align="center">
      <input name="city" type="text" id="city" size="35" maxlength="50">    
    </div></td>
  ...
  <tr>
    <td><input name="email" type="text" id="email" size="15" maxlength="50">
      <span class="maincontent">@sbsplanet.com</span></td>
    <td><div align="center">(
      <input name="ph1" type="text" id="ph1" value="000" size="3" maxlength="3">
      ) 
      <input name="ph2" type="text" id="ph2" value="000" size="3" maxlength="3">
      -
      <input name="ph3" type="text" id="ph3" value="0000" size="4" maxlength="4">
    </div></td>
  ...
  <tr>
    ...
    <td width="180" bgcolor="#CCCCCC" class="pageheader"><div align="center">Business Unit</div></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td><div align="center">
        <input name="rate" type="text" id="rate" value="0" size="10" maxlength="10">
    </div></td>
    <td>
	<select name="bu">
    <option value="0">Select One</option>
  ...
  <tr>
    <td colspan="3"><center><input type="submit" name="submit" value="     Add Personal     "></center></td>
    </tr>
</table>
</form>
