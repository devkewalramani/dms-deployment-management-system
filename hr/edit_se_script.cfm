...
<!---
Script updates tables with the new information from editse2.cfm
--->

<!--- concatanate username and domain for email address --->
...
Update dbo.SE Set Fname='#Form.fname#',Lname='#Form.lname#',type='#Form.type#',city='#Form.city#',state='#Form.state#',zip='#Form.zip#',username='#Form.email#',emailaddress='#emailadd#',cellphone='#form.cellphone#',EmpType='#Form.EmpType#',region='#region_lookup.region#',BU_group='#form.bu#',rate=#form.rate#,status='#status#' where EmpID='#Form.EmpID#'
</cfquery>
<br><br>
<cfoutput><center><span class="pageheader">#Form.Fname# #Form.Lname# has been updated!</span></center></cfoutput>
<br><br>
