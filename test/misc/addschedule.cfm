...
<cfif #Form.Travel# is 'Y'>

<cfquery name="add" datasource="SBSEFD">
INSERT INTO dbo.Schedule (DispatchID,OmniNum,projcode,ProjectName,ProjectCity,ProjectState,ProjectZip,In_Region,StartDate,StartTime,EndDate,EndTime,EmpID,SE_Lname,SE_Fname,SE_Type,ProjectType,Status,LOE_Price,Travel_Price,Bill_Travel,se_flag,dell_sku,ProjectSummary,ProjectNotes,DateAdded) VALUES ('#Form.DispatchID#','#Form.OmniNum#','#Form.projcode#','#Form.ProjectName#','#Form.ProjectCity#','#ProjectState#','#ProjectZip#','#in_region#','#Form.StartDate#','#StartTime#','#Form.EndDate#','#EndTime#','#Form.EmpID#','#Lname#','#Fname#','#SE_Lookup.type#','#Form.ProjectType#','#Form.Status#','#Form.LOE_Price#','#Form.Travel_Price#','#Form.Bill_Travel#','#Form.se_flag#','#Form.dell_sku#','#Form.ProjectSummary#','#Form.ProjectNotes#','#DateAdded#')
</cfquery>

<cfquery name="addtravel" datasource="SBSEFD">
INSERT INTO dbo.Travel (DispatchID,OmniNum,ProjectName,ProjectCity,ProjectState,ProjectZip,StartDate,StartTime,EndDate,EndTime,EmpID,SE_Lname,SE_Fname,TravelNotes,ProjectSummary,TR_Status,Flight,Hotel,Rental,ProjectType,TRDate) VALUES ('#Form.DispatchID#','#Form.OmniNum#','#Form.ProjectName#','#Form.ProjectCity#','#Form.ProjectState#','#Form.ProjectZip#','#Form.StartDate#','#StartTime#','#Form.EndDate#','#EndTime#','#Form.EmpID#','#Lname#','#Fname#','#TravelNotes#','#Form.ProjectSummary#','Submitted','#Form.Flight#','#Form.Hotel#','#Form.Rental#','#Form.ProjectType#','#TRDate#')
</cfquery>


<cfmail from = "dkewalramani@sbsplanet.com" To = "travel@sbsplanet.com,#SE_lookup.EmailAddress#" cc="DellManagement@SBSPlanet.com"
Subject = "#d_status# Travel Request - #Form.ProjectType# - (#Form.DispatchID#) #Form.OmniNum# - #Form.ProjectName# - #Form.StartDate# ">
   <cfmailpart 
      type="html">
<br>	  
...
<center><font color="##0000FF" class="style2">#Form.DispatchID# #Form.ProjectName# for #SE_lookup.Lname#,#SE_lookup.Fname# has been added!
<br>
...
<cfif #Form.Travel# is 'N'>

<cfquery name="add" datasource="SBSEFD">
<span class="style2"> INSERT INTO dbo.Schedule (DispatchID,OmniNum,projcode,ProjectName,ProjectCity,ProjectState,ProjectZip,In_Region,StartDate,StartTime,EndDate,EndTime,EmpID,SE_Lname,SE_Fname,SE_Type,ProjectType,Status,LOE_Price,Travel_Price,Bill_Travel,se_flag,dell_sku,ProjectSummary,ProjectNotes,DateAdded) VALUES ('#Form.DispatchID#','#Form.OmniNum#','#Form.projcode#','#Form.ProjectName#','#Form.ProjectCity#','#Form.ProjectState#','#Form.ProjectZip#','#in_region#','#Form.StartDate#','#StartTime#','#Form.EndDate#','#EndTime#','#Form.EmpID#','#Lname#','#Fname#','#SE_Lookup.type#','#Form.ProjectType#','#Form.Status#','#Form.LOE_Price#','#Form.Travel_Price#','#Form.Bill_Travel#','#Form.se_flag#','#Form.dell_sku#','#Form.ProjectSummary#','#Form.ProjectNotes#','#DateAdded#') </span>
</cfquery>

<cfquery name="addtravel" datasource="SBSEFD">
<span class="style2"> INSERT INTO dbo.Travel (DispatchID,OmniNum,ProjectName,ProjectCity,ProjectState,ProjectZip,StartDate,StartTime,EndDate,EndTime,EmpID,SE_Lname,SE_Fname,TravelNotes,ProjectSummary,TR_Status,Flight,Hotel,Rental,ProjectType) VALUES ('#Form.DispatchID#','#Form.OmniNum#','#Form.ProjectName#','#Form.ProjectCity#','#Form.ProjectState#','#Form.ProjectZip#','#Form.StartDate#','#StartTime#','#Form.EndDate#','#EndTime#','#Form.EmpID#','#Lname#','#Fname#', '#TravelNotes#', '#Form.ProjectSummary#','Not Submitted', '#Form.Flight#','#Form.Hotel#','#Form.Rental#', '#Form.ProjectType#') </span>
</cfquery>

<center>
  <span class="style2"><font color="##FF0000">#Form.DispatchID# #Form.ProjectName# for #SE_lookup.Lname#,#SE_lookup.Fname# has been added! 
  <br>
Travel Request has been <strong>NOT SUBMITTED!</strong></font></span>
</center>
...
<cfquery name="addtravel" datasource="SBSEFD">
<span class="style2"> INSERT INTO dbo.Travel (DispatchID,OmniNum,ProjectName,ProjectCity,ProjectState,ProjectZip,StartDate,StartTime,EndDate,EndTime,EmpID,SE_Lname,SE_Fname,ProjectSummary,TR_Status,ProjectType) VALUES ('#Form.DispatchID#','#Form.OmniNum#','#Form.ProjectName#','#Form.ProjectCity#','#Form.ProjectState#','#Form.ProjectZip#','#Form.StartDate#','#StartTime#','#Form.EndDate#','#EndTime#','#Form.EmpID#','#Lname#','#Fname#','#Form.ProjectSummary#','NA','#Form.ProjectType#') </span>
</cfquery>
