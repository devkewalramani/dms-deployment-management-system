...
<!--- Script to DM's to the database --->

<cfquery name="adddm" datasource="SBSEFD">
INSERT INTO dbo.DM (Fname,Lname,DeskPhone,MobilePhone,Email) VALUES ('#Form.fname#','#Form.lname#','#Form.deskphone#','#Form.cellphone#','#Form.Email#')
</cfquery>
<br><br>
<cfoutput><center><span class="pageheader">#Form.Fname# #Form.Lname# has been added to the DM list!</span></center></cfoutput>
<br><br>
