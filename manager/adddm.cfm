...
<!--- Form to add DM's to the DM table --->
<form action="./add_dm_script.cfm" method="post" name="form">
<table width="616">
  <tr>
    <td width="50%" bgcolor="#CCCCCC" class="pageheader"><div align="center">First Name </div></td>
    <td width="50%" bgcolor="#CCCCCC" class="pageheader"><div align="center">Last Name </div></td>
    </tr>
  <tr>
    <td>
  ...
  <tr>
    <td bgcolor="#CCCCCC" class="pageheader"><div align="center">Desk Phone </div></td>
    <td width="50%" bgcolor="#CCCCCC" class="pageheader"><div align="center">Cell Phone </div></td>
    </tr>
  <tr>
    <td>
      <div align="center">
        <input name="deskphone" type="text" size="35" maxlength="50" value="(   )  -    ">    
        </div></td>
    <td width="50%"><div align="center">
      <input name="cellphone" type="text" size="35" maxlength="50" value="(   )  -    ">
    </div></td>
    </tr>
  <tr>
  ...
  <tr>
    <td>
          <div align="center">
            <input name="email" type="text" id="email" size="35" maxlength="50" value="@dell.com">
              </div></td><td width="50%"><div align="center"></div></td>
  </tr>
  <tr>
    <td colspan="2"><center><input type="submit" name="submit" value="Add DM"></center></td>
    </tr>
</table>
</form>
