...
<center>
<!---
This form is for entering dates for Project Completion, EOE Dates and CAF dates
--->
...
<cfoutput query="schcurrent">
 <!--- do as long status not canceled --->
 <cfif #status# neq 'Canceled'>
 
 <cfquery name="proj_tracking" datasource="SBSEFD">
 Select *
 ...
 <cfform name="form" method="post" action="doc_trackingscript.cfm" target="_blank">
  <tr>
    <td bgcolor="##FFFFFF" class="maincontent"><strong>Project Completion</strong>
      <input name="type"type="hidden" value="1"><input name="RID"type="hidden" value="#URL.RID#"></td>
	 <td bgcolor="##FFFFFF" class="maincontent">
	 Date
	   <cfinput name="proj_complete_date" type="text" value="#dateformat(proj_tracking.proj_complete_date,'mm/dd/yyyy')#" size="10" maxlength="10" validate="date" required="yes" message="Please enter the date the project completed">	 </td>
	  <td bgcolor="##FFFFFF" class="maincontent">&nbsp;</td>
...
<cfform name="form" method="post" action="doc_trackingscript.cfm" target="_blank">
  <tr>
    <td bgcolor="##FFFFFF" class="maincontent"><strong>CAF Completion</strong>
      <input name="type"type="hidden" value="2"><input name="RID"type="hidden" value="#URL.RID#"></td>
	 <td bgcolor="##FFFFFF" class="maincontent">
	 Date 
	   <cfinput name="caf_complete_date" type="text" value="#dateformat(proj_tracking.caf_complete_date,'mm/dd/yyyy')#" size="10" maxlength="10" required="yes" validate="date" message="Please enter the date the CAF was submitted">	 </td>
	  <td bgcolor="##FFFFFF" class="maincontent">
	   Compliant:
	   <select name="CAF_Compliant">
            <option value="#proj_tracking.CAF_Compliant#">#proj_tracking.CAF_Compliant#</option>
            <option value="">--</option>
...
<cfform name="form" method="post" action="doc_trackingscript.cfm" target="_blank">
  <tr>
    <td bgcolor="##FFFFFF" class="maincontent"><strong>EOE Completion</strong>
      <input name="type"type="hidden" value="3"><input name="RID"type="hidden" value="#URL.RID#"></td>
	 <td bgcolor="##FFFFFF" class="maincontent">
	 Date 
	   <cfinput name="eoe_complete_date" type="text" value="#dateformat(proj_tracking.eoe_complete_date,'mm/dd/yyyy')#" size="10" maxlength="10" required="yes" validate="date" message="Please enter the date the EOE was completed">	 </td>
	  <td bgcolor="##FFFFFF" class="maincontent">
	  Compliant: 
	  <select name="EOE_Compliant">
            <option value="#proj_tracking.EOE_Compliant#">#proj_tracking.EOE_Compliant#</option>
            <option value="">--</option>
            <option value="Y">Yes</option>
            <option value="N">No</option>
            </select>			</td>
...
<!--- Notes Form --->
<form name="form" method="post" action="doc_trackingscript.cfm" target="_blank">
<tr>
<td bgcolor="##FFFFFF" class="maincontent"><strong>Notes</strong><input name="type"type="hidden" value="4"><input name="RID"type="hidden" value="#URL.RID#"></td>
<td bgcolor="##FFFFFF" colspan="2"><textarea name="notes" cols="60" rows="3">#proj_tracking.notes#</textarea></td>
<td bgcolor="##FFFFFF"><input type="submit" name="Submit" value="Submit"></td>
</tr>
</form>
</table>

 <cfelseif #status# eq 'Canceled'>
  <table width="616" bgcolor="##CCCCCC">
  <tr>
    <th bgcolor="##FFFFFF" class="maincontent" scope="col"><strong>Project Canceled</strong></th>
  </tr>
  <tr>
    <td bgcolor="##FFFFFF" class="maincontent"><div align="center"><strong>Date:</strong> #dateformat(CancelDate,'mm/dd/yyyy')# <strong>Reason:</strong> #CancelReason# <strong>Notes:</strong> #CancelNotes#</div></td>
  </tr>
</table>
 </cfif>
