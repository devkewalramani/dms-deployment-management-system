...
<!--- allows to search for a project --->

	<cfquery name="project" datasource="SBSEFD">
	Select *
	From dbo.Proj_Type
	Order by Type ASC
	</cfquery>
	<center>
	<span class="pageheader">Search for a project</span>
	<br>
	<!--- Keyword Search--->
	<form name="FORM" method="post" action="./select.cfm">
	<span class="maincontent">Keyword Search</span> 
  	<input name="search" type="text" size="35" maxlength="200">
	<input type="hidden" name="searchcode" value="1">
  	<input type="submit" name="Submit" value="     Search     ">
	</form>
	<hr noshade="noshade" color="#CCCCCC">
	<!---Specfic Search--->
	<form name="FORM" method="post" action="./select.cfm">
	<span class="maincontent">Dexterra ID:</span> 
  	<input type="text" name="DispatchID">
	<span class="maincontent style24">SBS Project Code: </span> 
  	<input name="proj_code" type="text" id="proj_code" style="background:#CCCCCC" readonly="yes">
	<input type="hidden" name="searchcode" value="2">
	<br>
 	<span class="maincontent">Project Type</span>
	...
	<option value="#Proj_Type_ID#">#Type#</option>
  	...
  	<span class="maincontent">Status</span>
  	<select name="Status">
	<option value="0">All</option>
