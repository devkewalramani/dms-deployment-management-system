...
<!---
This page allows to select a date range to run a report on all cancelations
--->	
	
	<span class="pageheader">Enter date range to generate the cancelations report</span><br>
<form name="form" action="cancelations.cfm" method="post" target="_blank">
