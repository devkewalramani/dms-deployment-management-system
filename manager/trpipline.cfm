...
<!--
.style27 {font-size: 9; }
.style28 {font-size: 9; font-weight: bold; }
-->
</style>
<!-- InstanceEndEditable -->
</head> 
...
<!---
This page displays all projects that a travel request has not been submitted for
--->

<!--- search travel table for all projects where the travel status is equal to Not Submitted --->
...
<cfset date1 = Now()>
<span class="pageheader">Pending Travel Requests</span>
<br>
<div style="height: 400px; width: 616; overflow: auto">
<table width="100%" bgcolor="#CCCCCC">
  <tr>
    <th bgcolor="#FFFFFF" class="maincontent" scope="col"><div align="center" class="style27"><strong>Type</strong></div></th>
    <th bgcolor="#FFFFFF" class="maincontent" scope="col"><div align="center" class="style28">Customer </div></th>
	<th bgcolor="#FFFFFF" class="maincontent" scope="col"><div align="center" class="style28">Engineer</div></th>
    <th bgcolor="#FFFFFF" class="maincontent" scope="col"><div align="center" class="style28">Start Date </div></th>
...
<!--- the output will color in the projects that are less than 8 days from being started--->
<cfset numofdays = #search.startdate# - #date1#>
<cfif #numofdays# lte 8>
<form name="form"  method="post" action="pending.cfm" target="_blank"> 
  <tr>
    <td bgcolor="##BD4701" class="maincontent">
	<div align="center" class="style27">
	<input name="RID" type="hidden" value="#search.RID#">
	#Proj_Type_lookup.Type#
    </div>	
	</td>
    <td bgcolor="##BD4701" class="maincontent"><div align="center" class="style27">#search.ProjectName#</div></td>
	<td bgcolor="##BD4701" class="maincontent"><div align="center" class="style27">#search.SE_Lname#,#search.SE_Fname#</div></td>
    <td bgcolor="##BD4701" class="maincontent"><div align="center" class="style27">#DateFormat(search.StartDate,'mm/dd/yyyy')#</div></td>
	<td bgcolor="##BD4701"><input name="Submit" type="submit" value="Select" ></td>
    </tr>
</form>	
<cfelse>
<form name="form"  method="post" action="pending.cfm" target="_blank"> 
  <tr>
    ...
    <td bgcolor="##FFFFFF" class="maincontent"><div align="center" class="style27">#search.ProjectName#</div></td>
	<td bgcolor="##FFFFFF" class="maincontent"><div align="center" class="style27">#search.SE_Lname#,#search.SE_Fname#</div></td>
    <td bgcolor="##FFFFFF" class="maincontent"><div align="center" class="style27">#DateFormat(search.StartDate,'mm/dd/yyyy')#</div></td>
	<td bgcolor="##FFFFFF" class="maincontent"><input name="Submit" type="submit" value="Select" ></td>
    </tr>
</form>
</cfif>
</cfoutput>
