...
<!--- This will allow to search for a particular project to send a travel request for --->
<span class="pageheader">Search for project to send a travel request for</span><br>
<form name="FORM" method="post" target="_blank" action="./pending.cfm">
  <span class="pageheader">
  <label>Dexterra ID:</label>
  </span>
  <label> 
