...
<!---
Date and engineer selection to veiw schedule be indivdual engineer
--->
...
<span class="pageheader">Select Engineer and Date Range to view schedule</span><br>

<form name="Form" action="engschedule.cfm" method="post" target="_blank"> 
<table width="200" >
  <tr>
    <th class="maincontent" scope="row" align="right">Start Date</th>
    <td><CF_CT_DATE_INPUT NAME="sdate"></td>
  </tr>
  <tr>
    <th class="maincontent" scope="row" align="right">End Date</th>
