...
<!---
Select a type of engineer to view that schedule
--->
<cfquery name="team" datasource="SBSEFD">
...
<table width="282" align="center">
  <tr>
    <th class="maincontent" scope="col"><div align="center">Team</div></th>
    </tr>
  <tr>
    <td>
	<form name="form" method="post" action="teamschedule.cfm" target="_blank">
	  <div align="center">
	    <select name="type">
	      <option value="">--</option>
	      <cfoutput query="team">
