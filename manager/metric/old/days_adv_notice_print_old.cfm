...
from dbo.schedule
Where (Startdate between '#form.startdate#' and '#form.enddate#') and (ProjectType ='EFD' or ProjectType ='EFD/LOE')
</cfquery>
...
<cfchart font="Arial" showXGridlines="yes" showYGridlines="yes" show3d="yes" labelformat="percent" chartheight="400" chartwidth="600" title="Days Advance Notice from #form.startdate# to #form.enddate#" format="jpg"> 
