...
<!--- lookup deployment managers  --->
<cfquery name="DM_Lookup" datasource="SBSEFD">
Select Lname, Fname
From dbo.DM
Order by Lname ASC
</cfquery>
<!--- lookup all engineers  --->
...
<!--- form to schedule a new project --->
<center>
  <form name="form" method="post" action="./addschedule.cfm">
    <table width="616" border="0">
      ...
      <tr>
        <th colspan="3" bgcolor="#CCCCCC" class="pageheader" scope="row">Dell Specific </th>
      </tr>
      <tr>
        <th width="121" class="maincontent" scope="row"><div align="right"><strong><span class="maincontent style10">*</span><span class="style25">Dispatch #:</span> </strong></div></th>
        <td colspan="2" class="maincontent"><strong>
          ...
          <input name="dell_pid" type="text" id="dell_pid" size="15" maxlength="25">
        </strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <th width="121" class="maincontent" scope="row"><div align="right"><strong><span class="style10">*</span> SBS Project Code:</strong></div></th>
        <td colspan="2" class="maincontent"><strong>
          <input name="projcode" type="text" id="projcode" size="10" maxlength="10">
          <span class="maincontent style10">*</span><span class="style25">PO #: 
          <input name="PO_Num" type="text" id="PO_Num" size="25" maxlength="25">
          </span></strong></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2" class="maincontent"><strong>
          ...
          <span class="style28"><a href="./zipcode.cfm"></a></span></strong></td>
      </tr>
      <tr>
