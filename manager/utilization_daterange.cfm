...
<!--- date range selection for util report--->
<span class="pageheader">Enter date range to generate the utilization report</span><br>
<form name="form" action="./utilization.cfm" method="post" target="_blank">
